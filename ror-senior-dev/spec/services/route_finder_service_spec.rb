...
RSpec.describe RouteFinder::RouteFinderService do
  ...
  let(:service) { described_class.new(test_data) }
  ...
  describe '#find_cheapest_direct' do
    ...
    it 'excludes sailings without exchange rates' do
      data_missing_rate = test_data.dup
      data_missing_rate['exchange_rates'].delete('2022-01-30')

      service_with_missing = described_class.new(data_missing_rate)
